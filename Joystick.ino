...
int highScore=0; //saving the highest score 

// Difficulty, time to react
const int easy=1000;
...
switch (sSY) {
  ...
  {
    wins++;
    for (int k=0; k<=3; k++) {     //blinking green light means correct choice
  ...
  else
  {
    ...
    for (int i=0; i<=3; i++) {       //blinking red light means incorrect choice
